...
import com.flowShop.spring.Dtos.ProductRequest;
...
public class ProductService {
    ...
    public ProductResponse update(Integer id, ProductRequest request, MultipartFile image) throws Exception {
        Product product = repository.findById(id)
        ...
        if (!product.getUser().getId().equals(user.getId())) {
            throw new RuntimeException("You are not permitted to modify this product");
        }
